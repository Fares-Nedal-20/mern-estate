...
export default function About() {
  return (
    <div className="py-28 px-3 max-w-6xl mx-auto flex flex-col gap-8">
      <h1 className="text-3xl sm:text-6xl font-semibold text-slate-700">About Mohammed Estate</h1>
      <p className="text-gray-600">
        Mohammed Estate is a leading real estate agency that specializes in helping
